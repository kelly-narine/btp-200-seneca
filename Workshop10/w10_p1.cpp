...
int main()
{
	...
	seneca::Pair<seneca::Book, int>* ret2 = seneca::matches(bks, x, 4, size1, size3);
	...
	seneca::Pair<seneca::Book,double>* ret3 = seneca::matches(bks, y, 4, size2, size3);
	...
	seneca::Pair<seneca::Student, int>* ret4 = seneca::matches(stds, x, 7, size1, size3);
	...
	seneca::Pair<seneca::Student,double>* ret5 = seneca::matches(stds, y, 7, size2, size3);
